...
def fetch_cargo_dep_list(package_name: str, base_repo_url: str) -> list[str]:
    # В online/offline режиме мы не знаем, где лежат другие пакеты.
    # Вместо этого — будем использовать тестовый режим для демонстрации.
